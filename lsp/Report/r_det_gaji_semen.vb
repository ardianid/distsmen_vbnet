...
Public Class r_det_gaji_semen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "lsp.r_det_gaji_semen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedr_det_gaji_semen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As r_det_gaji_semen = New r_det_gaji_semen()
        rpt.Site = Me.Site
        Return rpt
    End Function
