...
Public Class r_gaji_sales_tot
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "lsp.r_gaji_sales_tot.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedr_gaji_sales_tot
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As r_gaji_sales_tot = New r_gaji_sales_tot()
        rpt.Site = Me.Site
        Return rpt
    End Function
