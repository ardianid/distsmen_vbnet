...
Public Class r_det_gaji_angkutl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "lsp.r_det_gaji_angkutl.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_supir() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedr_det_gaji_angkutl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As r_det_gaji_angkutl = New r_det_gaji_angkutl()
        rpt.Site = Me.Site
        Return rpt
    End Function
