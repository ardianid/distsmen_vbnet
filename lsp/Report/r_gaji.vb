...
Public Class r_gaji
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_bulanthn() As CrystalDecisions.[Shared].IParameterField
        Get
