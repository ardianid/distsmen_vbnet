...
Public Class r_gaji_sales_det
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "lsp.r_gaji_sales_det.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedr_gaji_sales_det
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As r_gaji_sales_det = New r_gaji_sales_det()
        rpt.Site = Me.Site
        Return rpt
    End Function
