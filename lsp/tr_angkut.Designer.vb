...
Partial Class tr_angkut
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(tr_angkut))
        ...
        Me.NMTOKO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.ALM_AKT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.ALM_TUJ = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.BARANG = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.JML_AKT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.SATUAN_AKT = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.cbfind.Items.AddRange(New Object() {"NO BUKTI", "TANGGAL", "CUSTOMER", "ALAMAT KIRIM", "BARANG", "SUPIR", "NO POLISI"})
        ...
        Me.grid1.Size = New System.Drawing.Size(932, 366)
        Me.grid1.TabIndex = 132
        Me.grid1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.gridview})
        '
        'gridview
        '
        Me.gridview.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.NOBUKTI, Me.TANGGAL, Me.NMTOKO, Me.ALM_AKT, Me.ALM_TUJ, Me.BARANG, Me.JML_AKT, Me.SATUAN_AKT})
        ...
        'NMTOKO
        '
        Me.NMTOKO.Caption = "Customer"
        Me.NMTOKO.FieldName = "CUST_ORDER"
        Me.NMTOKO.Name = "NMTOKO"
        Me.NMTOKO.OptionsColumn.AllowEdit = False
        Me.NMTOKO.Visible = True
        Me.NMTOKO.VisibleIndex = 2
        Me.NMTOKO.Width = 149
        '
        'ALM_AKT
        '
        Me.ALM_AKT.Caption = "Alamat Angkut"
        Me.ALM_AKT.FieldName = "ALAMAT_ANGKUT"
        Me.ALM_AKT.Name = "ALM_AKT"
        Me.ALM_AKT.OptionsColumn.AllowEdit = False
        Me.ALM_AKT.Visible = True
        Me.ALM_AKT.VisibleIndex = 3
        Me.ALM_AKT.Width = 158
        '
        'ALM_TUJ
        '
        Me.ALM_TUJ.Caption = "Alamat Tujuan"
        Me.ALM_TUJ.FieldName = "ALAMAT_TUJUAN"
        Me.ALM_TUJ.Name = "ALM_TUJ"
        Me.ALM_TUJ.OptionsColumn.AllowEdit = False
        Me.ALM_TUJ.Visible = True
        Me.ALM_TUJ.VisibleIndex = 4
        Me.ALM_TUJ.Width = 132
        '
        'BARANG
        '
        Me.BARANG.Caption = "Barang"
        Me.BARANG.FieldName = "BARANG_ANGKUT"
        Me.BARANG.Name = "BARANG"
        Me.BARANG.Visible = True
        Me.BARANG.VisibleIndex = 5
        Me.BARANG.Width = 136
        '
        'JML_AKT
        '
        Me.JML_AKT.AppearanceHeader.Options.UseTextOptions = True
        Me.JML_AKT.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
        Me.JML_AKT.Caption = "Jml"
        Me.JML_AKT.DisplayFormat.FormatString = "n3"
        Me.JML_AKT.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.JML_AKT.FieldName = "JML"
        Me.JML_AKT.Name = "JML_AKT"
        Me.JML_AKT.OptionsColumn.AllowEdit = False
        Me.JML_AKT.Visible = True
        Me.JML_AKT.VisibleIndex = 6
        Me.JML_AKT.Width = 65
        '
        'SATUAN_AKT
        '
        Me.SATUAN_AKT.Caption = "Satuan"
        Me.SATUAN_AKT.FieldName = "SATUAN"
        Me.SATUAN_AKT.Name = "SATUAN_AKT"
        Me.SATUAN_AKT.OptionsColumn.AllowEdit = False
        Me.SATUAN_AKT.Visible = True
        Me.SATUAN_AKT.VisibleIndex = 7
        Me.SATUAN_AKT.Width = 97
        '
        ...
        Me.ClientSize = New System.Drawing.Size(932, 402)
        Me.Controls.Add(Me.grid1)
        Me.Controls.Add(Me.bn1)
        Me.Name = "tr_angkut"
        Me.Text = "Angkutan lain kendaraan :::"
    ...
    Friend WithEvents NMTOKO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents ALM_AKT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents ALM_TUJ As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents BARANG As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents JML_AKT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents SATUAN_AKT As DevExpress.XtraGrid.Columns.GridColumn
