...
Partial Class ms_kec
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ms_kec))
        ...
        Me.KABUPATEN = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.bn1.Size = New System.Drawing.Size(796, 36)
        Me.bn1.TabIndex = 126
        ...
        Me.cbfind.Items.AddRange(New Object() {"KODE", "NAMA", "KABUPATEN"})
        ...
        Me.grid1.Size = New System.Drawing.Size(796, 371)
        Me.grid1.TabIndex = 129
        Me.grid1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.gridview})
        '
        'gridview
        '
        Me.gridview.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.KABUPATEN, Me.KODE, Me.NAMA})
        ...
        Me.gridview.SortInfo.AddRange(New DevExpress.XtraGrid.Columns.GridColumnSortInfo() {New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.KABUPATEN, DevExpress.Data.ColumnSortOrder.Ascending)})
        '
        'KABUPATEN
        '
        Me.KABUPATEN.Caption = "Kabupaten"
        Me.KABUPATEN.FieldName = "KABUPATEN"
        Me.KABUPATEN.Name = "KABUPATEN"
        Me.KABUPATEN.OptionsColumn.AllowEdit = False
        Me.KABUPATEN.OptionsColumn.AllowMerge = DevExpress.Utils.DefaultBoolean.[True]
        Me.KABUPATEN.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "PROPINSI", "TOTAL : {0:n}")})
        Me.KABUPATEN.Visible = True
        Me.KABUPATEN.VisibleIndex = 0
        Me.KABUPATEN.Width = 172
        '
        'KODE
        '
    ...
    Friend WithEvents KABUPATEN As DevExpress.XtraGrid.Columns.GridColumn
