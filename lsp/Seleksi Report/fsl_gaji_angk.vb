...
Public Class fsl_gaji_angk
    ...
    Private Sub ttahun_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles ttahun.KeyDown
        If e.KeyCode = 13 Then
            cbbulan.Focus()
    ...
    Private Sub fsl_gaji_angk_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ttahun.Focus()
    End Sub

    Private Sub fsl_gaji_angk_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btpre_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btpre.Click
        ...
        Dim gajilain As New pr_gaji_aktl(bulan, ttahun.EditValue, tkode_spir.Text.Trim, tnama_spir.Text.Trim, cbbulan.Text.Trim) With {.WindowState = FormWindowState.Maximized}
        gajilain.Show()
