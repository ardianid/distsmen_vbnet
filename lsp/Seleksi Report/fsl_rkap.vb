...
Public Class fsl_rkap
    ...
    Private Sub btpre_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btpre.Click
        ...
        Dim fpr_rekap As New pr_rkap_order(ttgl.EditValue, ttgl2.EditValue, cbarea.EditValue, cbarea.Text.Trim) With {.WindowState = FormWindowState.Maximized}
        fpr_rekap.Show()
