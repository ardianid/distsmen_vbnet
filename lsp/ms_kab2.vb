...
Public Class ms_kab2
    ...
    Private Sub isi_combo()
        ...
        Const sql = "select kode,nama from admlsp.MS_PROP order by nama asc"
    ...
    Private Sub isi_box()
        ...
        cbstatus.EditValue = dv(posi)("KD_PROP").ToString

    End Sub

    Private Sub edit()

        Dim sql As String = String.Format("update admlsp.ms_kab set nama='{0}',kode_prop='{1}',user_edit='{2}',tgl_edit='{3}'" & _
        ...
        Try
            ...
            ins_to_temp_user(cn, sql, tkode.Text.Trim, "MS_KAB", "UPDATE", "KABUPATEN")
    ...
    Private Sub insert()
        ...
        Dim sql As String = String.Format("insert into admlsp.ms_kab (kode,nama,kode_prop,user_add,tgl_add) values" & _
        ...
        Dim sql_search As String = String.Format("select kode from admlsp.ms_kab where kode='{0}'", tkode.Text.Trim)
        ...
        Try
            ...
            ins_to_temp_user(cn, sql, tkode.Text.Trim, "MS_KAB", "INSERT", "KABUPATEN")
    ...
    Private Sub insert_view()
        ...
        orow("PROPINSI") = cbstatus.Text
        orow("KD_PROP") = cbstatus.EditValue
    ...
    Private Sub update_view()
        ...
        dv(posi)("PROPINSI") = cbstatus.Text
        dv(posi)("KD_PROP") = cbstatus.EditValue
