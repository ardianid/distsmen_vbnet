...
Public Class pr_gaji_aktl
    ...
    Private Sub open_data()
        ...
        sql = String.Format("SELECT V_GAJI_ANGKUTL.TANGGAL, V_GAJI_ANGKUTL.CUST_ORDER, V_GAJI_ANGKUTL.ALAMAT_TUJUAN, V_GAJI_ANGKUTL.JML, V_GAJI_ANGKUTL.SATUAN, V_GAJI_ANGKUTL.OKS_ANGKUT, V_GAJI_ANGKUTL.TOT_OKS_ANGKUT, V_GAJI_ANGKUTL.UANG_JLN, V_GAJI_ANGKUTL.SUPIR " & _
                "FROM   ADMLSP.V_GAJI_ANGKUTL V_GAJI_ANGKUTL " & _
                "WHERE extract(month from V_GAJI_ANGKUTL.TANGGAL)='{0}' and extract(year from V_GAJI_ANGKUTL.TANGGAL)='{1}' and V_GAJI_ANGKUTL.kd_supir='{2}' " & _
                "ORDER BY V_GAJI_ANGKUTL.SUPIR", bln, thn, kodekaryawan)
        ...
        Try
            ...
            Dim objRpt As New r_det_gaji_angkutl
