...
Public Class pr_jual_beli_detail
    ...
    Sub New(ByVal ttgl1 As Date, ByVal ttgl2 As Date, ByVal kode_areas As String, ByVal nama_areas As String, ByVal kdkab As String)
    ...
    Private Sub open_data()
        ...
        sql = String.Format("SELECT V_SELISIH_HARGA.KABUPATEN, V_SELISIH_HARGA.NAMA_TOKO, V_SELISIH_HARGA.NODO, V_SELISIH_HARGA.TANGGAL, V_SELISIH_HARGA.HARGA, V_SELISIH_HARGA.HARGA_BELI, V_SELISIH_HARGA.TOT_JML " & _
                "FROM   ADMLSP.V_SELISIH_HARGA V_SELISIH_HARGA " & _
                "WHERE V_SELISIH_HARGA.TANGGAL >='{0}' and V_SELISIH_HARGA.TANGGAL <='{1}' ", convert_date_to_eng(tgl1), convert_date_to_eng(tgl2))

        If Not (kode_area.ToUpper = "ALL") Then
            sql = String.Format(sql & " AND V_SELISIH_HARGA.KD_STAT='{0}'", kode_area)
        End If

        If Not (kodekab.ToUpper = "ALL") Then
            sql = String.Format(sql & " AND V_SELISIH_HARGA.KODE_KAB='{0}'", kodekab)
        End If
        ...
        Try
            ...
            Dim objRpt As New r_selisih_detail
