...
Public Class sr_kab
    ...
    Private Sub opendata()
        ...
        sql = "select b.NAMA as PROPINSI,a.KODE,a.NAMA from admlsp.ms_kab a inner join admlsp.ms_prop b on a.KODE_PROP=b.KODE order by b.NAMA asc"
    ...
    Private Sub cari()
        ...
        Dim sql As String = ""
            ...
            Select Case cbkriteria.SelectedIndex
                Case 0
                sql = String.Format("select b.NAMA as PROPINSI,a.KODE,a.NAMA from admlsp.ms_kab a inner join admlsp.ms_prop b on a.KODE_PROP=b.KODE WHERE a.KODE like '%{0}%' order by b.NAMA asc", tcari.Text.Trim.ToUpper)
            Case 1
                sql = String.Format("select b.NAMA as PROPINSI,a.KODE,a.NAMA from admlsp.ms_kab a inner join admlsp.ms_prop b on a.KODE_PROP=b.KODE WHERE a.NAMA like '%{0}%' order by b.NAMA asc", tcari.Text.Trim.ToUpper)
        End Select
